...
# General
AUTHOR = "Jeff Watkins"
APP_NAME = "filer"  # must be package name i.e. directory under /src/
APP_AUTHOR = "psionman"
...
# GUI
APP_TITLE = "File and directory launcher"
ICON_FILE = Path(Path(__file__).parent, "images", "folder-search-outline.png")
