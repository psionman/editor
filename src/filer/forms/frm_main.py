...
from psiutils.treeview import TreeColumn, sort_treeview
from psiutils.utilities import window_resize

from filer.config import read_config
from filer.constants import APP_TITLE
from filer.data_server import FileData, load_files
from filer.forms.frm_edit_file import EditFrame
from filer.main_menu import MainMenu
from filer.text import Text
from filer.utilities import get_path, open_in_kate

# from filer.forms.frm
...
class AppFrame:
    ...
    def _button_frame(self, master: tk.Frame) -> tk.Frame:
        ...
        frame.buttons = [
            ...
            frame.icon_button("copy_clipboard", self._copy_item, True),
    ...
    def _context_menu(self) -> tk.Menu:
        menu_items = [
            ...
            MenuItem("Copy", self._copy_item, dimmable=True),
            Separator(),
    ...
    def _copy_item(self, *args) -> None:
        clipboard.copy(self.file_to_edit.path)
